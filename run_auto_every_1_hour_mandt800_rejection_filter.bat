...
echo ==================================================
echo CTM V44 daily 12:00 foreground runner
echo This replaces the old hourly foreground loop.
echo Keep this window open. Close it to stop the foreground runner.
echo For a true background daily task, run setup_daily_5pm_task_mandt800_rejection_filter.bat instead.
echo ==================================================
echo.
